...
<section class="section properties-listing">
    ...
    <div class="container">
        <div class="section-heading">
            <h1>
            @if(request()->input('type') == 'listAllProperty')
                All Properties
            @elseif(request()->input('type') == 'listCollectionProperty')
                Properties for All Collections
            @else
                Properties in 
            @endif

            <span class="mlocation">
            ...
            <div class="total-stays">
                <span class="totStayCount">{{ $propertyCount ?? '' }} out of {{ $totalStays ?? '' }} {{ $totalStays == 1 ? 'Stay' : 'Stays' }}</span>
            </div>
            ...
            <div class="col-12 col-xl properties-col" style="min-width: 0">
                                ...
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <a class="dropdown-item {{ request('sort_by') === 'low_to_high' ? 'fw-bold' : '' }} lowToHigh"
                                                href="javascript:void(0)">
                                                 Price: Low to High
                                             </a>
                                            ...
                                            <li>
                                                ...
                                                <a class="dropdown-item {{ request('sort_by') === 'high_to_low' ? 'fw-bold' : '' }} highToLow"
                                                    href="javascript:void(0)">
                                                        Price: High to Low
                                                </a>
                                            </li>
                ...
                @if($properties->hasMorePages())
                    <div class="properties-loader text-center mt-5">
                        <a class="btn btn-link loadPaginationP" data-page="{{ $properties->currentPage() + 1 }}">
...
<script>
    locationId = "@isset($locations->id) {{ $locations->id }} @endisset";
    checkin_date = "@isset($checkin_date) {{ $checkin_date }} @endisset";
    checkout_date = "@isset($checkout_date) {{ $checkout_date }} @endisset";
    guest = "@isset($guestCount) {{ $guestCount }} @endisset";
