...
<section class="section properties-listing">
    ...
    <div class="container">
        <div class="section-heading">
            <h1>Properties in <span class="mlocation">All</span></h1>
                ...
                <div class="row align-items-center filter-row">
                    ...
                    <div class="col-auto">
                        <div class="fl-group">
                            ...
                            <!--    <li class="dropdown">-->
                            <!--        <a class="btn dropdown-toggle px-3" href="javascript:void(0)" data-bs-toggle="dropdown" aria-expanded="true">Price: Low to High <span class="icon-chevron-down"></span></a>         -->
                            <!--        <div class="dropdown-menu dropdown-menu-end">-->
                            <!--           <ul class="list-unstyled mb-0">-->
                            <!--                <li><a class="dropdown-item fw-bold" href="javascript:void(0)">Price: Low to High</a></li>-->
