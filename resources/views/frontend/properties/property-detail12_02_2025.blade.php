                        ...
                        <div class="row mb-3 align-items-center">
                            <div class="col">
                             ...
                             @if ($property && $property->homeReviews->isNotEmpty())
                                <div class="col-auto">
                                     @php
                                    $ratings = $property->homeReviews->pluck('rating')->filter(function ($value) {
                                        return is_numeric($value);
                                    });
                                    $averageRating = $ratings->isNotEmpty() ? $ratings->avg() : 5;
                                @endphp
                                    ...
                                    <div class="swiper reviewList">
                                        <div class="swiper-wrapper">
                                            @foreach ($property->homeReviews->sortByDesc('review_date') as $homeReviewsKey => $homeReview)
                                                <div class="swiper-slide" data-review-site="{{ $homeReview->review_type ?? '' }}">
                                                    <div class="reviewBox">
                                                        ...
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-auto">
                                                                <img src="{{ asset('storage/review/images/' . $homeReview->icons_image) }}" alt="">
                                                            </div>
                                                        </div>
        ...
        <div class="row">
            <div class="col">
                <div class="m-booking-info">
                    ...
                    <ul class="list-unstyled mb-0 bi-info book-link">
                        ...
                        <li>
                            <span class="totalNight"></span> nights                            
            ...
            <div class="col-auto">
                ...
                @endif
                    ...
                    <button type="submit" class="btn w-100 btn-primary px-3 make-reservation">Book Now</button>
                </form>
            </div>
