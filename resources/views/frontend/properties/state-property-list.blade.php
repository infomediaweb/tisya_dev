...
<section class="section properties-listing">
    ...
    <div class="container">
        <div class="section-heading">
            <h1>Properties in {{ $states->name ?? "" }}</h1>
                    ...
                    <div class="properties-listing">
                        @if(!empty($properties) && $properties->count() >0)
                            @foreach($properties as $property)
                                <div  href="{{ route('property-detail', ['slug' => $property->url_key]) }}" target="_blank" class="property-item">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg align-self-center py-3">
                                            ...
                                            <div class="location-state">
                                                        {{ $locations->location_name ?? '' }}, {{ $property->state }}
                                                    </div>
