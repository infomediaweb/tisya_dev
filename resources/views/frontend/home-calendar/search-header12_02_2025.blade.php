        ...
        <div class="row gy-3 gx-4">
            <div class="col-12 col-lg-3 d-flex field-col dropdown position-relative">
                <button class="btn form-select text-start search-field" type="button"  data-bs-toggle="dropdown" aria-expanded="false" data-bs-offset="0,5"  data-bs-display="static" data-search-id="location">
                    <span class="data-text data-text-location-sec">{{ session('location_name') ?? 'Location' }} </span>
                    <input type="hidden" id="locationID_sec" value="{{ session('city_id') }}" name="locationID_sec">
                    <input type="hidden" id="checkin_date_sec" value="{{ session('checkin_date') }}" name="checkin_date_sec">
                    <input type="hidden" id="checkout_date_sec" value="{{ session('checkout_date') }}"  name="checkout_date_sec">
                </button>
                   ...
                   <ul class="list-unstyled mb-0">
                    @if (!empty($location_data) && $location_data->isNotEmpty())
                        @foreach ($location_data as $location)
                            <li>
                                <a class="dropdown-item location-item-sec" href="#" data-locationid="{{ $location->id ?? '' }}" data-locationname="{{ $location->location_name ?? '' }}">
                                ...
                                <div class="col-auto">
                                    <div class="counter">
                                        ...
                                        <div class="counter-col">
                                            <input type="hidden" class="adults-count adultsCountSec" name="" value="{{ session('adultsCount') ? session('adultsCount') : 1 }}" data-adults-value>
                                            <strong class="count-val count-val-sec">{{ session('adultsCount') ? session('adultsCount') : 1 }}</strong>
                                        </div>
                            ...
                            <div class="row flex-nowrap align-items-center">
                                ...
                                <div class="col-auto">
                                    <div class="counter">
                                        ...
                                        <div class="counter-col">
                                            <input type="hidden" class="children-count childrenCountSec" name="" value="{{ session('childrenCount') ? session('childrenCount') : 0 }}" data-children-value>
                                            <strong class="count-val count-val-sec">{{ session('childrenCount') ? session('childrenCount') : 0 }}</strong>
                                        </div>
