                   ...
                   <ul class="list-unstyled mb-0">
                       ...
                       @foreach($states_with_locations as $state)
                            ...
                            @foreach($state->locations as $location)
                                <li>
                                    <a class="dropdown-item location-item" data-locid="{{ $location->location_name ?? '' }}" href="#" data-locationid="location" data-locationname="{{ $location->location_name ?? '' }}">
...
/* Calendar */
        ...
        dropdownItems.forEach(item => {
            item.addEventListener('click', function (event) {
                ...
                const locatID = this.getAttribute('data-locid');
                location_id.val(locatID); 
            });
        });
        ...
        function updateTotalGuests() {
            ...
            let totalGuest = Number(adultsCount);
