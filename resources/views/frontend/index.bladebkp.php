@extends('layout.main')
@section('content')
    <section class="section flex-wrap section-hero section-bg" style="z-index:1;">
            ...
            <div class="section-heading">
                <div class="row gy-3">
                    ...
                    <div class="col-auto align-self-center">
                        <a href="{{ route('properties') }}" class="orangeLink">Explore all properties</a>
                    </div>                   
                </div>
            </div>
                            ...
                            @foreach ($properties as $property)
                             @php $priceAndAvaliability = getPriceAndAvalibility($property->ru_property_id);   @endphp
                                <div class="swiper-slide">
                                 ...
                                 <a href="{{ route('property-detail', ['home_type' => strtolower($property->home_type), 'slug' => $property->url_key]) }}" target="_blank" class="card-img-top">
        ...
        <div class="container">
            <div class="section-heading">
                <div class="row gy-3">
                    ...
                    <div class="col-auto align-self-center">
                       <a href="{{ route('collections-property-list') }}" class="orangeLink">Explore all properties</a>
                    </div>                   
                </div>
            </div>           
                ...
                <div class="swiper-main-outer">
                    <div class="swiper swiper-collection">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('collection-property', ['slug' => $collection->collection_name]) }}" class="card card-collection">                                        
                                    <div class="imgBox">
                                         <!--<img loading="lazy" -->
        ...
        <div class="container">
            <div class="section-heading">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto align-self-end order-2 order-lg-0  ms-lg-auto">
...
<script>
    document.addEventListener('DOMContentLoaded', () => { 
        ...
        var swiper = new Swiper(".swiper-property", {
            ...
            navigation: {
                nextEl: ".property-section .swiper-outer-next",
                prevEl: ".property-section .swiper-outer-prev",
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
