...
<footer class="footer-main py-0 section">
            ...
            <div class="row gy-4">
                <div class="col-12 col-xl-3">
                    <div class="footer-logo">
                         <a href="{{route('index')}}">
                        <img src="{{ asset('assets/images/footer-logo.svg') }}" alt="Tisya Stays">
                          </a>
                    </div>
                </div>
                    ...
                    <div class="footer-links-wrapper">
                        <div class="row gy-4">
                            ...
                            <div class="col-12 col-md">
                                <ul class="footer-links">
                                    <li>
                                        <a href="{{ route('property-list', ['type' => 'listAllProperty']) }}">All Properties</a>
                                    </li>
                                    <li>
                            ...
                            <div class="col-12 col-md">
                                <ul class="footer-links">
                                    ...
                                    <li>
                                         <a href="{{route('cancellationandrefund')}}">Cancellation and Refund Policy</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-12 col-md">
                                <div class="social-media">
                                    ...
                                    <ul class="footer-links">
                                        <li>
                                            <a href="https://www.instagram.com/tisyastays/?utm_medium=copy_link" target="_blank"><i class="icon-instagram"></i></a>
                                        </li>
                                        <li>
                                            <a href="https://www.facebook.com/tisyastaysHQ/" target="_blank"><i class="icon-facebook"></i></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)"><i class="icon-linkedin"></i></a>
                                        </li>
                                        <li>
                                            <div style="display: inline-flex; align-items: center; font-family: Arial, sans-serif; font-size: 12px; color: #fff; border: 1px solid #e0e0e0; padding: 4px 8px; border-radius: 4px; background:#2b85b6;">
                                            <span>Secured&nbsp;by</span>
                                            <img src="{{asset('assets/images/razorpay-logo.svg')}}" alt="Razorpay" style="height: 16px; margin-left: 4px;">
                                            </div>
                                        </li>
                                    </ul>
                                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm">&copy; 2024 TISYA STAYS PRIVATE LIMITED | Designed by <a targe="_blank"  href="https://www.iws.in/">IWS</a></div>
                <div class="col-12 col-sm-auto"><button class="btn">Back to Top <i class="icon-arrow-top"></i></button></div>
            </div>
        </div>
    </div>
</footer>
...
<style>
    @media(max-width:1600px){
        .whatsapp-link, .call-link{right:1rem;}
    }
    @media(max-width:1300px){
        .detail-page .whatsapp-link{right:1rem; bottom:5.2rem;}
    }
    
    
</style>
<a href="https://wa.me/918799915100?text=Send a quote" class="whatsapp-link" onclick="fbq('track', 'Contact'); gtag('event', 'conversion', {'send_to': 'AW-16482594363/oLBgCMjMqpcaELvcwbM9'});" target="_blank">
...
<!--        </div>-->
<!--        <div class="col">-->
<!--            <a href="https://wa.me/+918799915100?text=Send a quote" class="btn btn-light" onclick="fbq('track', 'Contact'); gtag('event', 'conversion', {'send_to': 'AW-16482594363/oLBgCMjMqpcaELvcwbM9'});" target="_blank">-->
<!--                <svg xmlns="http://www.w3.org/2000/svg" width="78" height="78" viewBox="0 0 78 78">-->
<!--                <g id="Group_23" data-name="Group 23" transform="translate(-1809 -798)">-->
<!--                    <path id="Path_79" data-name="Path 79" d="M39,0A39,39,0,1,1,0,39,39,39,0,0,1,39,0Z" transform="translate(1809 798)" fill="#26a800"/>-->
<!--                    <path id="whatsapp-svgrepo-com" d="M41.515,10.4A21.653,21.653,0,0,0,26.068,4,21.9,21.9,0,0,0,7.089,36.8L4,48.135,15.586,45.1A21.854,21.854,0,0,0,41.515,10.4ZM26.068,44.08A18.149,18.149,0,0,1,16.8,41.543l-.662-.414L9.269,42.949l1.821-6.7-.441-.69a18.224,18.224,0,1,1,33.791-9.682A18.371,18.371,0,0,1,26.068,44.08Zm9.958-13.627c-.552-.276-3.227-1.6-3.724-1.765s-.883-.276-1.241.276a24.837,24.837,0,0,1-1.738,2.124c-.3.386-.634.414-1.186,0a14.7,14.7,0,0,1-7.42-6.482c-.579-.965.552-.91,1.6-2.979a1.048,1.048,0,0,0,0-.965c0-.276-1.241-2.979-1.683-4.055s-.883-.91-1.241-.938H18.316a1.958,1.958,0,0,0-1.462.69,6.041,6.041,0,0,0-1.821,4.662,10.537,10.537,0,0,0,2.234,5.655,24.522,24.522,0,0,0,9.351,8.275,10.622,10.622,0,0,0,6.565,1.379,5.517,5.517,0,0,0,3.669-2.593,4.468,4.468,0,0,0,.331-2.593A3.852,3.852,0,0,0,36.026,30.454Z" transform="translate(1823 809)" fill="#fff"/>-->
...
<script>
    ...
    const svgIcons = {
        "custom-home": `<svg viewBox="0 0 1260 1024"><path d="M630.157 172.072l301.177 271.059v470.438h-120.471v-361.412h-361.412v361.412h-120.471v-470.438l301.177-271.059zM630.157 10.039l-602.353 542.118h180.706v481.882h361.412v-361.412h120.471v361.412h361.412v-481.882h180.706l-602.353-542.118z"></path> </svg>`,
        "custom-no-late-check-outs": `<svg viewBox="0 0 853 1024"><path d="M90.776 847.887v-419.857h503.831v41.987c29.391 0 57.522 4.198 83.968 12.175v-54.162c0-46.184-37.785-83.968-83.968-83.968h-41.987v-83.968c0-115.882-94.048-209.93-209.93-209.93s-209.93 94.048-209.93 209.93v83.968h-41.987c-46.184 0-83.968 37.785-83.968 83.968v419.857c0 46.184 37.785 83.968 83.968 83.968h262.83c-17.636-25.193-31.491-53.741-40.728-83.968h-222.106zM216.736 260.087c0-69.698 56.259-125.957 125.957-125.957s125.957 56.259 125.957 125.957v83.968h-251.913v-83.968z"></path> <path  d="M594.607 553.987c-115.882 0-209.93 94.048-209.93 209.93s94.048 209.93 209.93 209.93c115.882 0 209.93-94.048 209.93-209.93s-94.048-209.93-209.93-209.93zM663.883 862.581l-90.268-90.268v-134.355h41.987v117.141l77.675 77.675-29.391 29.811z"></path> </svg>`
        
    }

    function replaceIcons() {
        const icons = document.querySelectorAll('i.icon-name')

        icons.forEach(icon => {
            const iconName = Array.from(icon.classList).find(cls => cls !== 'icon-name')

            if(svgIcons[iconName]) {
                const svgElement = document.createElement('i')
                svgElement.innerHTML = svgIcons[iconName]       
                svgElement.classList.add(iconName)                
                icon.replaceWith(svgElement)

                console.log(`Replaced ${iconName} with SVG`)
