...
<footer class="footer-main py-0 section">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col">&copy; 2024 Tisya Stays | Designed by <a targe="_blank"  href="https://www.iws.in/">IWS</a></div>
                <div class="col-auto"><button class="btn">Back to Top <i class="icon-arrow-top"></i></button></div>
            </div>
        </div>
    </div>
</footer>
