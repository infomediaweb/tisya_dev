        ...
        <div class="swiper hero-slides">
            ...
            <div class="swiper-wrapper">
                @foreach($home_banner as $banner)
                 <?php $heading = $banner->heading ; $subtitle = $banner->subtitle;  ?>
       ...
       <div class="d-table-cell align-middle">
              <div class="container">
                    <div class="collapsible-wrapper animFade">
                        <h2 style="">Experience Our Difference</h2>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane {{ $index === 0 ? ' show active' : '' }}" id="pane-{{ $invitation->id }}" role="tabpanel" aria-labelledby="{{ $invitation->id }}" tabindex="0">
                                    <div class="row g-4">
                                        ...
                                        <div class="col align-self-center ps-lg-5">
                                            <div class="tc-title">{{ $invitation->offer_name }}</div>
                                            <div class="tc-content">
                                                <p>{{ $invitation->headline }}</p>
                                            </div>
                            
                                            <div class="offer-date">Valid Till: {{ $invitation->validity }}</div>
                            
                                            <a href="#" class="btn btn-secondary" data-fancybox data-src="#offer-pop{{ $invitation->id}}">VIEW DETAILS</a>
                                        </div>
                                    </div>
                                </div>
                                <div id="offer-pop{{ $invitation->id}}" class="offer-popup popup">
                                    <div class="ic-info mb-4 pb-2">
                                        ...
                                        <h6>Valid Till: {{$invitation->validity}}</h6>
                                    </div>
    ...
    <section class="section section-home-owner bg-secondary-light2">
        ...
        <div class="container-fluid px-0">     
            ...
            <div class="btn-wrap animFade">
                <a href="join-our-network" class="btn btn-secondary" wire:navigate >JOIN OUR NETWORK</a>
            </div>
        </div>
    </section>
    @endforeach
                    ...
                    <div class="swiper-wrapper row gy-4 gx-3 gx-sm-4">
                        ...
                        <div class="col-12 col-md-4 animFade swiper-slide">
                            <a href="#" class="card card-secondary">
                                <div class="card-img-top">
                                    <span>
                                        <img loading="lazy" src="{{ asset('storage/blogs/' . $blog->image) }}" alt="Explore Our Newest Apartments in Kasauli Hills">
                                    </span>
                                </div>
                                <div class="card-footer">
                                    <time datetime="2024-01-20">{{$blog->date;}}</time>
                                    <h3>{{$blog->title}}</h3>
                                </div>
                            </a>
                        </div> 
    ...
    <section class="section section-tagline">
        <div class="container animFade">
            <div class="row gx-1 flex-nowrap">
                 <div class="col">
                     <div class="tagline-text"><span>Managing Luxury <br>Homes Since </span><strong>2014</strong></div>
                 </div>
                 <div class="col">
                     <div class="tagline-text"><span>Dedicated <br>Home Staff</span> <strong>100+</strong></div>
                 </div>
                 <div class="col">
                     <div class="tagline-text"><span>Hosted <br>Families</span> <strong>5000+</strong></div>
                 </div>
            </div>
        </div>
    </section>
