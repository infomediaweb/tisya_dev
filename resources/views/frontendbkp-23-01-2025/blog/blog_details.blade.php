                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <ul class="list-unstyled mb-0 d-flex align-items-center">
                                ...
                                <li>
                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ url()->current() }}" target="blank">
                                        <i class="icon-facebook"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/sharing/share-offsite?mini=true&url={{ url()->current() }}&title={{ $blog->title }}&summary=" target="blank">
