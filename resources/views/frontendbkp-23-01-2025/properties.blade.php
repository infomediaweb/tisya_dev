                    ...
                    <div class="filter-wrap">
                        <ul class="list-unstyled mb-0 d-flex align-items-center justify-content-lg-end">
                            <li class="dropdown">
                                ...
                                <form action="{{ route('filter-booking') }}" method="POST" id="filter-form">
                                @csrf
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu bg-secondary-light3">
                                    <li>
                                        <a class="active dropdown-item" href="{{ route('filter_booking_data', ['value' => 'low']) }}">
                                            Price Low to High
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="row gy-3">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        @foreach ($property['images'] as $media)
                                            <div class="swiper-slide">
                                                <img class="w-100" src="{{ $media['filename'] }}" alt="" loading="lazy">
                                            </div>
                                        @endforeach
                                    </div>
                                    @if ($imageCount > 1)
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <ul class="key-features nav">
                                    <li><span><img src="{{ asset('assets/images/occupancy.svg') }}" alt="8 Guests"></span><span>{{$property['maximum_number_of_guests']}} <br>Guests</span></li>
                                    <li><span><img src="{{ asset('assets/images/bedrooms.svg') }}" alt="3 Bedrooms"></span><span>{{$property['no_of_bedrooms']}} <br>Bedrooms</span></li>
                                    <li><span><img src="{{ asset('assets/images/bathrooms.svg') }}" alt="3 Bathrooms"></span><span>{{$property['no_of_bathrooms']}} <br>Bathrooms</span></li>
                                    <li><span><img src="{{ asset('assets/images/staff.svg') }}" alt="2 Staff"></span><span>{{$property['no_of_staff']}} <br>Staff</span></li>
                                    @if($property['pet_friendly'] == 1)
                                       <li><span><img src="{{ asset('assets/images/pet.svg') }}" alt="Pet Friendly"></span><span>Pet <br>Friendly</span></li>
                                    @else
                                    @endif
                                </ul>
                                @php
                            ...
                            @else
                                {{-- <div class="pr-price mb-4"> INR 0.00 /night</div> --}}
                            @endif
                                <div class="row g-3">
                                    <div class="col-auto">
