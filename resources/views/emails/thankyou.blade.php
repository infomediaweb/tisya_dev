...
<head>
    ...
    <title>Tisya Stays</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;background-color: #ffffff;" class="email-container">
            ...
            <tr>
                <td style="background-color: #F1F1F1;padding: 30px; font-family: Arial, sans-serif; font-size: 14px; line-height: 20px; color: #000000;" class="darkmode-bg">
                    ...
                    <p style="margin: 0;">
                        Thank You for the Payment, We have received your payment on <b>{{ date('j F Y', strtotime(date('Y-m-d'))) }}</b>. Your payment reference number is <b>{{$data->booking_id}}</b>. Thank you for your prompt attention to this matter.
                    </p>
                    <p style="margin: 25px 0 0;">
                        <b>Total Amount:</b> Rs.{{$data->payable_amount}}</br>
                        <b>Paid Amount:</b> Rs.{{$paymentRequestInfo->amount}}</br>
                    </p>
                </td>
            </tr>
