        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;background-color: #ffffff;" class="email-container">
            ...
            <tr>
                <td style="padding: 20px 30px; text-align: center;background-color: #ffffff;">
                    <a href="#" target="_blank"><img src="https://tisya.tempsite.in/assets/images/logo.png" width="272" height="72" alt="tistya stays" border="0" style="height: auto; font-family: Arial, sans-serif; font-size: 14px; line-height: 15px; color: #000000;"></a>
                </td>
            </tr>
	        <!-- Email Header : END -->
            <tr>
                <td style="background-color: #F1F1F1;padding: 30px; font-family: Arial, sans-serif; font-size: 14px; line-height: 20px; color: #000000;" class="darkmode-bg">
                    <h1 style="margin:0px 0px 5px 0px; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; color: #333333; font-weight: bold;">Dear {{ ucfirst($data->customer_detail['first_name']) }} {{ ucfirst($data->customer_detail['last_name']) }}</h1>
                    <p style="margin: 0;">
                        We are pleased to confirm your booking as per the details below: <br>
                        Thank you for choosing Tisya Stays. Your Booking ID is <strong>{{ $data->booking_id }}</strong>.
                    </p>
                </td>
            </tr>
            {{-- <tr>
	                                ...
	                                <tr>
	                                    <td dir="ltr" valign="top" style="font-family: sans-serif; font-size: 14px; line-height: 20px; color: #000000; text-align: left;">
                                            ...
                                            <p style="margin: 0 0 20px;">
                                                ...
                                                <!--@if($data->extra_guest_charge)-->
                                                <!--   Extra Guest Charge: INR {{$data->extra_guest_charge}}<br>-->
                                                <!--@endif-->
                                                <!--<b>Total Taxable Amount</b>: INR {{round($data->taxable_amount)}}<br>-->
                                                <!--Tax: {{$data->tax}}%<br>-->
                                                <!--Total Amount: INR {{round($data->tax_amount)}}<br>-->
                ...
                <tr>
                    <td style="background-color: #ffffff;border-top:1px solid #d9d9d9" class="darkmode-bg">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody><tr>
                                <td style="padding: 30px; font-family: Arial, sans-serif; font-size: 14px; line-height: 20px; color: #000000;">
                                    <p style="margin: 0 0 20px;"><strong>Cancellation & Refund Policy</strong></p>
                                    {!! setting()->cancellation_and_refund_policy !!}
                                    ...
                                    <tbody><tr>
                                        ...
                                        <td style="vertical-align: middle;padding-left: 5px;">
                                            ...
                                            <a href="https://www.facebook.com/tisyastaysHQ/" target="_blank">
                                                <img src="https://tisya.tempsite.in/assets/images/facebook.png" alt="Instagram" width="24" height="24" border="0" style="height: auto; font-family: Arial, sans-serif; font-size: 14px; line-height: 15px; display: block; color: #000000;">
                                            </a>
                                        </td>
                                        <td style="vertical-align: middle;padding-left: 5px;">
                                            ...
                                            <a href="https://www.instagram.com/tisyastays/?utm_medium=copy_link" target="_blank">
                                                <img src="https://tisya.tempsite.in/assets/images/instagram.png" alt="Instagram" width="24" height="24" border="0" style="height: auto; font-family: Arial, sans-serif; font-size: 14px; line-height: 15px; display: block; color: #000000;">
                                            </a>
