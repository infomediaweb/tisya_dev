    ...
    <![endif]-->
        ...
        <tr>
                ...
                <td style="padding: 20px 30px; text-align: center;background-color: #ffffff; border-bottom:1px solid #cccccc;">
                    ...
                    <img src="{{asset('assets/images/logo.png')}}" width="218" height="65" alt="Tisyastays" border="0" style="height: auto; font-family: Arial, sans-serif; font-size: 15px; line-height: 15px; color: #000000;">
            ...
            <tr> 
                ...
                <td style="padding: 20px 20px 10px 20px; font-family: Arial, sans-serif; font-size: 15px; line-height: 20px; color: #444444;">
                    

                    <h1 style="margin:0px 0px 5px 0px; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; color: #333333; font-weight: bold;"><b>Dear @if(!is_array($data->customer_detail)) {{ ucfirst(json_decode($data->customer_detail)->first_name) }} @else {{$data->customer_detail['first_name']}} {{$data->customer_detail['last_name']}} @endif,</b></h1>

                    <p style="margin: 0;">Your booking has been canceled. Booking ID: {{$data->booking_id}}.</p>
                    ...
                    <p >
                      ...
                      {{$data->home->home_name}} <br>

                      {{$data->checkin_date}} -  {{$data->checkout_date}}<br>  

                      Total Amount: Rs.{{$data->payable_amount}}<br>

                      Amount Paid: Rs.@if($data->paid_amount ==0.00) 0 @else {{$data->paid_amount}} @endif <br>

                      Due Amount:: Rs.{{$data->payable_amount - $data->paid_amount}}
                    ...
                    For any assistance or to make changes to your booking, please contact us at <a href="mail-to:reservations@tisyastays.com">reservations@tisyastays.com</a>
                    </p>

                    <!--<p class="text-center" style="text-align:center; color:rgb(79,100,75)">-->

                    <!--    <strong>NOOK & CO (Nook Stays Private Limited)</strong><br>-->

                    <!--    24013, Prestige Falcon City, Kanakpura Road,<br>-->
