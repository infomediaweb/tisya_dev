        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;background-color: #ffffff;" class="email-container">
            ...
            <tr>
                <td style="background-color: #F1F1F1;padding: 30px; font-family: Arial, sans-serif; font-size: 14px; line-height: 20px; color: #000000;" class="darkmode-bg">
                    ...
                    <p style="margin: 0;">
                        We are sorry to hear that you need to cancel your booking with Tisya Stays. Your
                        cancellation request has been processed, and we have canceled your reservation as
                        per your request.
                    </p>
                </td>
            </tr>
		                                            ...
		                                            <td>
														<div><!--[if mso]>
                                                            ...
                                                            @if($data->googlelocation_url)
                                                                <a href="{{$data->googlelocation_url}}"
                                                          style="background-color:#2D2424;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:34px;text-align:center;text-decoration:none;width:136px;-webkit-text-size-adjust:none;">Google Map</a>
                                                          @endif
                                                            <!--[if mso]>
                                                              </center>
                                                            </v:roundrect>
