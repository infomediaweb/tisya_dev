<template>
    <Form @submit="onSubmit" v-slot="{ meta, values, errors }">
        <div class="row">
            ...
            <div class="col-12 col-lg-3">
                <div class="form-group">
                    <label for="">Map Latitude<span class="text-danger">*</span></label>
                    <Field 
                        type="text" 
                        name="map_latitude"
                        class="form-control"
            ...
            <div class="col-12 col-lg-3">
                <div class="form-group">
                    <label for="">Map Longitude<span class="text-danger">*</span></label>
                    <Field 
                        type="text" 
                        name="map_longitude"
                        class="form-control"
...
<script setup>
    ...
    import { ref, toRef, onMounted, computed, nextTick } from 'vue'
    ...
    const onSubmit = (value, {resetForm}) => {
        ...
        axios.post(submitApiUrl.value, value).then(res => {
            if(res.data.status){
