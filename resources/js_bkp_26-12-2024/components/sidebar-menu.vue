    ...
    <div class="main-nav">
        <ul class="m-0 list-unstyled">
            ...
            <li class="has-dropdown">
                ...
                <div class="submenu">
                    <ul>
                        <li v-if="role == 'Admin'"><router-link :to="{name: 'by-location'}">New Booking</router-link></li>
                        <li><router-link :to="{name: 'booking-list'}">All Bookings</router-link></li>
                        <!-- <li><router-link :to="{name: 'booking-enquiry-list'}">Booking Enquiry</router-link></li> -->
                    </ul>
                </div>
            </li>
                        ...
                        <li class="has-multi-dropdown">
                            ...
                            <div class="submenu multi-level-menu">
                                <ul>
                                    ...
                                    <li>
                                        <router-link :to="{name: 'list-special-offer'}">Special Invitations</router-link>
                                    </li>
                                    <li>
