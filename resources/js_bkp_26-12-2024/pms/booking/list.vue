                            ...
                            <table class="table table-list-2 align-middle mb-0 mw-lg">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="125" v-if="role=='Admin' || role=='Finance' &&  role !='Reservations'">Action</th>
                                    </tr>
                                </thead>
                                <tbody v-for="(obj, index) in list" :key="index">
                                    <tr class="valignTop">
                                        ...
                                        <td v-if="role=='Admin' || role=='Reservations' || role=='Finance'">
                                            <ul class="action-btn-group mb-0 mw-0" v-if="obj.booking_from != 'ru'">
                                                ...
                                                <li v-if="(obj.booking_status == 'Paid' || obj.booking_status == 'paid' && role=='Admin' || role=='Finance') && !obj.invoice && obj.property_booking_status !='Canceled'">
                                                ...
                                                <li v-if="role !='Reservations' && obj.property_booking_status !='Canceled'">
                                                    <router-link
