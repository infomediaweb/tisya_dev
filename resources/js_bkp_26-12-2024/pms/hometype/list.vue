        ...
        <div class="page-title mb-4">
            <div class="row gy-3 align-items-center">
                <div class="col align-self-end">
                    <h1 class="h2 mb-0">Home Type List</h1>
                </div>
                ...
                <div class="col-auto">
                    <router-link :to="{name: 'add-home-type'}" class="btn rounded-pill btn-secondary-light">
                                    ...
                                    <tr v-for="(obj, index) in rowArray">
                                        ...
                                        <td>
                                            <ul class="action-btn-group mb-0 mw-0">
                                                <li>
                                                    <router-link :to="{name: 'add-home-type', params: { id: obj.id }}" class="btn ps-0 p-1 fs-5 text-black">
...
<script setup>
    ...
    const deleteItem = (v) => {
        ...
        function confirm(){
            axios.delete(`/api/hometype/${v}`).then(res => {
                if(res.data.status){
    ...
    const deleteMultiItem = () => {
        ...
        function confirm(){
            axios.post(`/api/hometype-delete-multiple`, {
    ...
    const updateStatus = (v, {target}) => {
        axios.post(`/api/hometype-update-status/${v}`, {
