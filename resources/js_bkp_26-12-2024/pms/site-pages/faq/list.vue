    ...
    <div class="page-wrap property-add">
        <div class="page-title mb-4">
            <div class="row gy-3 align-items-center">
                ...
                <div class="col-auto">
                    <router-link :to="{name: 'add-faq'}" class="btn rounded-pill btn-secondary-light">
                                    ...
                                    <tr v-for="(obj, index) in faqsList" :key="index">
                                        ...
                                        <td>
                                            <ul class="action-btn-group mb-0 mw-0">
                                                <li>
                                                    <router-link :to="{name: 'add-faq', params: { id: obj.id }}" class="btn ps-0 p-1 fs-5 text-black">
...
<script setup>
    ...
    const deleteItem = (v) => {
        ...
        function confirm(){
            axios.delete(`/api/faqs/${v}`).then(res => {
                if(res.data.status){
    ...
    const deleteMultiItem = () => {
        ...
        function confirm(){
            axios.post(`/api/faqs-delete-multiple`, {
    ...
    const updateStatus = (v, {target}, idx) => {
        axios.post(`/api/faqs-update-status/${v}`, {
    ...
    const onDragChange = (e) => {
        ...
        axios.post('/api/faqs-save-position', {
