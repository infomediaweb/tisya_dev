                                ...
                                <div class="col-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <ckeditor
                                            ...
                                            :class="{'border-danger': errors.cancellation_policy}"
                                            v-model:data="aboutEdit.cancellation_policy"
                                            rules="required"
                                        />
                                    </div> 
                                </div>
...
<script setup>
    ...
    const getAboutEdit = () => {
        ...
        axios.get('/api/cancellation-policy').then(res => {
            if(res.data.status){
    ...
    const onSubmit = (v) => {
        ...
        if(terms_id){
            var submitApiUrl = `/api/cancellation-policy/${terms_id}`
            }
        else{
        var submitApiUrl = '/api/cancellation-policy'
        } 
