<template>
    <div class="page-wrap property-add">
        <div class="page-title mb-4">
            <div class="row gy-3 align-items-center">
                <div class="col align-self-end">
                    <h1 class="h2 mb-0">Amenity List</h1>
                </div>
                ...
                <div class="col-auto">
                    <router-link :to="{name: 'add-amenities'}" class="btn rounded-pill btn-secondary-light">
        ...
        <section class="section">
            ...
            <template v-else>
                <div class="outer-wrapper" v-if="amenitiesList.length">
                    <div class="table-wrap">
                        <div class="table-responsive">
                            <table class="table align-middle mb-0 mw-lg">
                                ...
                                <tbody>
                                    <tr v-for="(obj, index) in amenitiesList" :key="index">
                                        <td>
                                            <input
                                                class="form-check-input form-check-lg mt-0"
                                                ref="selectCheckRef"
                                        ...
                                        <td>
                                            <ul class="action-btn-group mb-0 mw-0">
                                                <li>
                                                    <router-link :to="{name: 'add-amenities', params: { id: obj.id }}" class="btn ps-0 p-1 fs-5 text-black">
...
<script setup>
    ...
    const getAmenitiesList = (pageNumber) => {
        ...
        axios.get('/api/amenities', {
            ...
            if(res.data.status){
                amenitiesList.value = res.data.data.data
    ...
    const deleteItem = (v) => {
        ...
        function confirm(){
            axios.delete(`/api/amenities/${v}`).then(res => {
                if(res.data.status){
    ...
    const deleteMultiItem = () => {
        ...
        function confirm(){
            axios.post(`/api/amenities-delete-multiple`, {
    ...
    const updateStatus = (v, {target}) => {
        axios.post(`/api/amenities-update-status/${v}`, {
