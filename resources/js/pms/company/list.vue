        ...
        <div class="page-title mb-4">
            <div class="row gy-3 align-items-center">
                <div class="col align-self-end">
                    <h1 class="h2 mb-0">Company List</h1>
                </div>
                ...
                <div class="col-auto">
                    <router-link :to="{name: 'add-company'}" class="btn rounded-pill btn-secondary-light">
                            ...
                            <table class="table align-middle mb-0 mw-lg">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="35%" class="text-secondary fw-semibold">Name</th>
                                        <th class="text-secondary fw-semibold">State</th>
                                        <th width="12%" class="text-secondary fw-semibold">GST No.</th>
                                        <th width="15%" class="text-secondary fw-semibold">CIN No.</th>
                                    ...
                                    <tr v-for="(obj, index) in rowArray">
                                        ...
                                        <td>
                                            <ul class="action-btn-group mb-0 mw-0">
                                                <li>
                                                    <router-link :to="{name: 'add-company', params: { id: obj.id }}" class="btn ps-0 p-1 fs-5 text-black">
