                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-6 col-lg col-xxl-3">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label for="">Stay dates between <small>(From/To, including the starting and end night)</small><span class="text-danger">*</span></label>
                                        <div class="row gy-3">
                                            <div class="col">
                                                <Field
...
<script setup>
        ...
        if(route.params.id){
            ...
            axios.get(`/api/coupon/code/show/${route.params.id}`).then(res => {
                if(res.data.status){
                    ...
                    propertyType.value = JSON.parse(couponEditData.value.property_type_id)
                    propertyId.value = JSON.parse(couponEditData.value.property_id)
    ...
    const onSubmit = (v) => {
        ...
        submitApiUrl.value = route.params.id ? `/api/coupon/code/show/${route.params.id}` : '/api/coupon/code/save'
