...
class LocationController extends Controller{
    ...
    public function index(Request $request){
        ...
        try {
            ...
            $query = TblLocation::query()->select('tbl_location.*',DB::raw('CONCAT("/storage/home/images/", image) as image'),'tbl_states.name as state_name','tbl_states.state_code')
            ->leftJoin('tbl_states', 'tbl_states.id', '=', 'tbl_location.state_id');
...
// }
    ...
    public function show(Request $request, $id)
    {
        ...
        try {
           ...
           $data = TblLocation::select('tbl_location.*', 'image as image_name', DB::raw('CONCAT("/storage/home/images/",image) as image'))->find($id);
    ...
    public function deleteImageLocation($id){
        ...
        $locations = TblLocation::find($id);
        $image = "public/home/images/".$locations->image;
        if(!empty($image)){
    ...
    public function updateShowOnLocation(Request $request, $id){

        try{
            $query = TblLocation::findOrFail($id);
            $request->validate([
                'show_on_location'=> 'required|boolean',
            ]);

            $query->show_on_location_page = $request->show_on_location;
            if ($query->save()) {
                return response()->json([
                    'status' => true,
